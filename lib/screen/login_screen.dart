                      ...
                      decoration: InputDecoration(
                          ...
                          prefixIcon: Padding(
                            ...
                            child: Icon(
                              ...
                              color:
                                  colo1 == true ? Colors.green : Colors.black,
                              size: 20,
                            ), // Change this icon as per your requirement
                          ),
                          hintText: "Email",
                          hintStyle: TextStyle(
                            color: colo1 == true ? Colors.green : Colors.black,
                          )),
                    ),
                    SizedBox(
                      height: 10,
                      ...
                      decoration: InputDecoration(
                          ...
                          prefixIcon: Padding(
                            ...
                            child: Icon(
                              ...
                              color:
                                  colo2 == true ? Colors.green : Colors.black,
                              size: 20,
                            ), // Change this icon as per your requirement
                          ),
                          suffixIcon: InkWell(
                          ...
                          hintText: "Password",
                          hintStyle: TextStyle(
                            color: colo2 == true ? Colors.green : Colors.black,
                          )),
                    ),
                    SizedBox(
                      height: 18,
                ...
                child: GestureDetector(
                  onTap: () async {
                    if (_formKey.currentState!.validate()) {
                      ...
                      // sharedPreferences.setString('username', _text.text);
                      // sharedPreferences.setString('password', _text1.text);
                      // setState(() {
                      //   login();
                      // });
                    }
