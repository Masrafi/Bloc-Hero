...
class LiveTenderDetailsScreen extends StatelessWidget {
  const LiveTenderDetailsScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) => LiveTenderDetailsBloc(
            RepositoryProvider.of<RepositoryLiveTenderDetails>(context),
          )..add(LiveTenderDetailsLoadEvent()),
        ),
        BlocProvider(
      ...
      child: Scaffold(
          appBar: header(context, titleText: "Live"),
          body: BlocListener<SaveTenderBloc, SaveTenderState>(
            ...
            child: BlocBuilder<LiveTenderDetailsBloc, LiveTenderDetailsState>(
                builder: (context, state) {
              if (state is LiveTenderDetailsLoadingState) {
                return const Center(
                  child: CircularProgressIndicator(),
                );
              }
              if (state is LiveTenderDetailsErrorState) {
                return Center(
                  child: Text("Error"),
                );
              }
              if (state is LiveTenderDetailsLoadedState) {
                List<LiveTenderDetailsModel> dataList = state.users;
