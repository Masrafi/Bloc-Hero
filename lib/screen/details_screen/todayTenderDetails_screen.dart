    ...
    return MultiBlocProvider(
      ...
      child: Scaffold(
          ...
          body: BlocListener<SaveTenderBloc, SaveTenderState>(
            ...
            child: BlocBuilder<TodayTenderDetailsBloc, TodayTenderDetailsState>(
                builder: (context, state) {
              if (state is TodayTenderDetailsLoadingState) {
                return const Center(
                  child: CircularProgressIndicator(),
                );
              }
              if (state is TodayTenderDetailsErrorState) {
                return Center(
                  child: Text("Error"),
                );
              }
              if (state is TodayTenderDetailsLoadedState) {
                List<TodayTenderDetailsModel> dataList = state.users;
